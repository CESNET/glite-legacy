...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.7.6d 2005-12-29 12:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.7.6d 2005-12-29 12:00:00 GMT")
#endif
...
{ *t = NULL;
  ...
  { /* TODO: consider truncating UTF8 to ASCII for XML attribute strings? */
  }
  return soap->error;
}
#endif
